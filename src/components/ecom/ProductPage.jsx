                       ...
                       return (
                         <button 
                                ...
                                onClick={ 
                                    ( e ) => {  
                                    this.setState({ 
                                                selectedColor: _.uniq(
                                                        [ ...this.state.selectedColor,e.target.id ]
                                                    ),
                                                statusColor:  _.uniq(
                                                        [...this.state.statusColor,e.target.id]
                                                    ) 
                                            }) 
                                        } 
                                    }
                                id={ attr.value }
                                className={ `ui ${attr.value.toLowerCase()} circular label ${ this.state.selectedColor.includes(attr.value) ? 'disabled': '' }` } 
                            >
                    ...
                    return (
                        ...
                        <button 
                            ...
                            onClick={ ( e ) => {
                                  this.setState({
                                    selectedSize: _.uniq(
                                        [ ...this.state.selectedSize,e.target.id ] 
                                       ),
                                    statusSize: _.uniq(
                                        [...this.state.statusSize,e.target.id]
                                    ) })
                                 } }
                            className={`mini ui button ${ this.state.selectedSize.includes(attr.value) ? 'disabled': '' }`}
                            key={ attr.attribute_value_id }
                        >   {attr.value}  </button>
            ...
            <div className='ui grid'> 
                <div className='four wide column'>
                    ...
                    <div className='ui list'>
                        <div className='item'>
                        { this.state.selectedColor.length === 0 ? '' : <h4 className="ui header">Color</h4>}
                        ...
                        <div className='item'>
                            ...
                            { this.state.selectedSize.length === 0 ? '' : <h4 className="ui header">Size</h4> }
                            <div role="list" className="ui horizontal list">
